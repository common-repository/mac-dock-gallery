...
WordPress Mac Photo Gallery is a useful plug-in that will enhance the user experience by providing a Mac Dock Effect to the images in your web site. This plug-in is one of the best ever plug-ins available in the WordPress Plug-in Directory. This allows users to view a suave, trendy, and also a useful photo display option on your site.

Mac Dock Effect is wherein you can actually view the images aligned in a rectangular or flat format and it will zoom around individual picture while the user moves his cursor to the thumbnail of the image. This thus creates a dock effect on the screen in an effective and precise manner. Apart from improving the user interface and user experience this also improves usability and visual appeal of the web page.
...
Mac Photo Gallery Demo - http://www.apptha.com/demo/mac-photo-gallery
...
* Ajax Pagination used to view the entire album list
* Maximized view for the picture comes with a carousal effect.
* Facebook style viewing for individual pictures is available.
* Style of the Mac Dock – rounded, winged, etc can be customized by the admin.
* The height of the thumbnail and its size can be altered or set in the back end
* The Mac Dock effect’s resolution and proximity can be set by the admin.
* In the back end the admin of the site or site owner can set the  number of images that should be displayed on a single row.
...
2. Transfer the entire Mac Photo Gallery directory to your /plugins/ directory
3. Activate the Mac Photo Gallery through the 'Plugins' menu in WordPress
4. That's it! You're done.

== Screenshots ==

1. **Preview Image** - Displays the detailed view of particular image.

2. **Manage Albums** - Displays albums and details about the album.

3. **Preview Album** - Displays the detailed view of particular album.

4. **Import Albums** - Here you can import albums from Google picasa, Flickr and Facebook.

5. **Gallery settings** - You can control Gallery and Plugin here.

== Other Notes ==

= To Add Album and Photos =
1. Log on to Admin panel.
...
=How to contact the support / development team of our Mac Photo Gallery? =
You can contact us through,
Live Chat at http://www.apptha.com
Email: assist@apptha.com
Forums at http://www.apptha.com/forum/viewforum.php?f=30